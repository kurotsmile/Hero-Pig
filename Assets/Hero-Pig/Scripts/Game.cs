...
public class Game : MonoBehaviour, Carrot_Gamepad_Event
{
    ...
    void Start()
    {
        ...
        this.ads.onRewardedSuccess+=this.on_Rewarded_Success;
        ...
        gamepad1.set_gamepad_Joystick_left(gamepad_keydown_left);
        gamepad1.set_gamepad_Joystick_right(gamepad_keydown_right);
        gamepad1.set_gamepad_Joystick_up(gamepad_keydown_up);
        gamepad1.set_gamepad_Joystick_down(gamepad_keydown_down);
        ...
        this.pig.load(this);
        this.pig2.load(this);
        camSmoothCamera.set_cam_follow(true);
    }
